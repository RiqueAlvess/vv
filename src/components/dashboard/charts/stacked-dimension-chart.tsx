      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={240}>
          <BarChart data={chartData} layout="vertical" margin={{ left: 80, right: 20, top: 4, bottom: 4 }}>
            ...
            <XAxis type="number" domain={[0, 100]} tick={{ fontSize: 10, fill: '#333333' }} unit="%" />
            <YAxis type="category" dataKey="name" tick={{ fontSize: 10, fill: '#333333' }} width={80} />
            ...
            <Bar dataKey="Crítico"    stackId="a" fill="#8C6A2A" radius={[0, 4, 4, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
