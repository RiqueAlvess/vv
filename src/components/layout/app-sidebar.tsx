...
import { LayoutDashboard, Building2, Users, FileBarChart2, LogOut, ChevronUp, MessageSquare, KeyRound, BookOpen, ScrollText, Bell, ArrowLeftRight, Loader2, ClipboardList, Shield } from 'lucide-react';
...
const navItems = {
  ...
  ADM: [
    ...
    { title: 'Cotações Trial', url: '/adm/cotacoes', icon: ClipboardList },
    { title: 'Base de Conhecimento', url: '/articles', icon: BookOpen },
